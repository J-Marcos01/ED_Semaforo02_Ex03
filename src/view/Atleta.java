...
public class Atleta {
	...
	int perm=5;
	int permPodio=1; 
	Semaphore semaforoTiro=new Semaphore(perm);
	Semaphore semaforoPodio=new Semaphore(permPodio);
	
	for(int i=1;i<26;i++)
	{
		ThreadTriatlo t=new ThreadTriatlo(i,semaforoTiro,semaforoPodio);
		t.start();
	}
